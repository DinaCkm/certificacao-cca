...
export const DEFAULT_CONFIG: SiteConfig = {
  ...
  comoFunciona: {
    ...
    etapas: [
      ...
      { numero: "04", titulo: "Validação Documental", descricao: "A banca avaliadora analisa seus documentos em até 5 a 10 dias úteis. Você receberá um e-mail com o resultado e o próximo passo." },
