...
export const DEFAULT_CONFIG: SiteConfig = {
  hero: {
    ...
    titulo: "Certificação Controller ANEFAC",
    tituloDestaque: "Transforme sua Carreira!",
    subtitulo: "Para profissionais que primam pela educação continuada e que buscam se aperfeiçoar por meio do estudo e da dedicação, alcançando o nível mais avançado de capacitação.",
    ctaPrimario: "Ver certificações disponíveis",
    ctaSecundario: "Como funciona",
    stat1Valor: "100%",
    stat1Label: "processo online",
    stat2Valor: "2",
    stat2Label: "categorias de certificação",
    stat3Valor: "56+",
    stat3Label: "anos de credibilidade",
  },
  institucional: {
